...
class HomeBottomNavigation extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final activeContractsCount = ref
        .watch(buyerContractsProvider)
        .when(
          data: (contracts) =>
  ...
  Widget _buildBuyerNavigation(
    ...
    final buyerItems = [
      ...
      _NavItem(
        ...
        badgeCount: activeContractsCount,
      ),
            ...
            child: Stack(
              ...
              children: [
                ...
                Positioned.fill(
                  ...
                  child: Row(
                    children: [
                      Expanded(child: _buildFarmerIconItem(farmerItems[0])),
                ...
                Positioned(top: -4, child: _buildFarmerVoiceItem()),
              ],
            ),
          ),
        ),
  ...
  Widget _buildFarmerVoiceItem() {
    return Tooltip(
      message: 'Tekan lalu bicara',
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          const VoiceMicButton(size: 66, tooltip: 'Tekan lalu bicara'),
