...
class UpcomingEventsBanner extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<UpcomingEventsBanner> createState() => _UpcomingEventsBannerState();
}

class _UpcomingEventsBannerState extends ConsumerState<UpcomingEventsBanner> {
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    ...
                    const Color(0xFF042F1E).withOpacity(0.88),
                    const Color(0xFF021B11).withOpacity(0.98),
                  ],
                  stops: const [0.0, 0.55, 1.0],
                ),
              ),
            ),
            // Tappable content overlay
            Material(
              ...
              child: InkWell(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      // Top Row: Category Tag + Countdown Badge
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Container(
