...
class _AddFarmScreenState extends ConsumerState<AddFarmScreen> {
  ...
  Future<void> _detectGps() async {
    ...
    try {
      ...
      final regionApi = RegionApiService(
      ...
      _showMessage(
        'Gagal mengambil GPS. Pastikan izin lokasi aktif.',
      );
    }
  }
  ...
  Future<void> _submit() async {
    ...
    if (_polygonPoints.length < 3) {
      _showMessage(
        'Tambahkan minimal 3 titik batas lahan.',
      );
      return;
    }
    ...
    try {
      ...
      final resolved =
          _resolvedLocation ??
          await regionApi.resolveCoordinates(
            center.lat,
            center.lng,
          );

      final farmApi = FarmApiService(
        ref.read(apiClientProvider),
      );
      ...
      final farm = await farmApi.createFarm(
        ...
        boundaryCoordinates: _polygonPoints
            .map(
              (point) => {
                'lat': double.parse(
                  point.lat.toStringAsFixed(7),
                ),
                'lng': double.parse(
                  point.lng.toStringAsFixed(7),
                ),
              },
            )
            .toList(),
                  ...
                  SizedBox(
                    ...
                    child: FilledButton.icon(
                      onPressed: () {
                        ...
                        context.go(
                          '/land/season/start?farmId=${farm.id}&flow=setup',
                        );
                      },
                      icon: const Icon(
  ...
  Future<void> _primaryAction() async {
    ...
    if (_stepIndex == 1) {
      ...
      if (_polygonPoints.length < 3) {
        _showMessage(
          'Tambahkan minimal 3 titik batas lahan pada peta.',
        );
        return;
      }
  ...
  String get _secondaryLabel {
    if (_stepIndex > 0) {
      return 'Kembali ke Step Sebelumnya';
    }
  ...
  void _syncArea() {
    final areaHa = _calculateAreaHa(
      _polygonPoints,
    );

    final newValue = areaHa > 0
        ? areaHa.toStringAsFixed(2)
        : '';

    if (_areaController.text == newValue) {
      return;
    }
  ...
  String? _validatePositiveNumber(
    ...
    if (parsed == null) {
      return 'Luas dihitung setelah minimal 3 titik.';
    }
  ...
  _FarmPoint _calculateCenter(
    List<_FarmPoint> points,
  ) {
    if (points.isEmpty) {
      return const _FarmPoint(
        lat: 0,
        lng: 0,
      );
    }

    final lat = points.fold<double>(
      0,
      (sum, point) => sum + point.lat,
    );

    final lng = points.fold<double>(
      0,
  ...
  Widget _buildStepContent(
            ...
            TextFormField(
              ...
              decoration:
                ...
                labelText:
                    'Nama Petak Sawah',
                hintText:
                    'Contoh: Sawah Blok Cariu / Petak Timur',
                prefixIcon: Icon(
    ...
    if (_stepIndex == 2) {
      return _FormPanel(
        title: 'Karakteristik',
        subtitle:
            'Lengkapi kondisi sawah sebelum disimpan.',
        child: Column(
          children: [
            // SISTEM IRIGASI
            // ====================================================
              ...
              data: (irrigationTypes) {
                if (irrigationTypes.isEmpty) {
                  return DropdownButtonFormField<String>(
                    ...
                    hint: const Text(
                      'Belum ada sistem irigasi tersedia',
                    ),
                  );
                }
                ...
                final isValueValid = _irrigationType != null &&
                    irrigationTypes.any(
                      (item) =>
                          item.code == _irrigationType ||
                          item.name == _irrigationType,
                    );

                final effectiveValue = isValueValid
                    ? _irrigationType
                    : (irrigationTypes.isNotEmpty
                        ? (irrigationTypes.first.code.isNotEmpty
                            ? irrigationTypes.first.code
                            : irrigationTypes.first.name)
                        : null);
                ...
                return DropdownButtonFormField<String>(
                  ...
                  items: irrigationTypes.map((type) {
                    final valueKey =
                        type.code.isNotEmpty ? type.code : type.name;
              ...
              error: (err, stack) => DropdownButtonFormField<String>(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton(
                    ...
                    onPressed: () {
                      ref.invalidate(irrigationTypesProvider);
                    },
                  ),
                ),
              ...
              data: (soilTypes) {
                if (soilTypes.isEmpty) {
                  return DropdownButtonFormField<String>(
                    ...
                    hint: const Text(
                      'Belum ada jenis tanah tersedia',
                    ),
                  );
                }
                ...
                return DropdownButtonFormField<String>(
                  ...
                  hint: const Text(
                    'Pilih jenis / tekstur tanah (Opsional)',
                  ),
                  items: soilTypes.map((soil) {
                    final valueKey =
                        soil.code.isNotEmpty ? soil.code : soil.name;
              ...
              error: (err, stack) => DropdownButtonFormField<String>(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton(
                    ...
                    onPressed: () {
                      ref.invalidate(soilTypesProvider);
                    },
                  ),
                ),
            ...
            TextFormField(
              ...
              decoration:
                ...
                labelText: 'Catatan',
                hintText:
                    'Kondisi irigasi, akses jalan, atau blok saluran',
                alignLabelWithHint:
                    true,
              ),
            ),
    ...
    return _FormPanel(
      ...
      subtitle:
          'Periksa kembali data sawah Anda sebelum disimpan ke sistem.',
      child: Column(
        crossAxisAlignment:
            CrossAxisAlignment.stretch,
        children: [
              ...
              children: [
                ...
                _buildSummaryRow(
                  ...
                  value:
                      ...
                      '(${(areaHa * 10000).toStringAsFixed(0)} m²)',
                  valueColor:
                      padiGreen,
                ),
                ...
                _buildSummaryRow(
                  ...
                  label:
                      'Titik Polygon',
                  value:
                      '${_polygonPoints.length} titik koordinat',
                ),
                ...
                if (resolvedLocation !=
                  ...
                  _buildSummaryRow(
                    ...
                    label:
                        'Wilayah Desa / Kec',
                    value:
                        '${resolvedLocation.village?.name ?? '-'}, '
                        '${resolvedLocation.district?.name ?? '-'}',
                  ),
                ],
                ...
                _buildSummaryRow(
                  ...
                  value: _getIrrigationTypeName(
                    ref.watch(irrigationTypesProvider).asData?.value,
                  ),
                ),
                if (_soilType != null && _soilType!.isNotEmpty) ...[
                  ...
                  _buildSummaryRow(
                    ...
                    label: 'Tipe Tanah',
                    value: _getSoilTypeName(
                      ref.watch(soilTypesProvider).asData?.value,
                    ),
                  ),
                ],
              ],
  ...
  String _getIrrigationTypeName(
    List<IrrigationTypeModel>? list,
  ) {
    if (_irrigationType == null || _irrigationType!.isEmpty) {
      return '-';
    }
    ...
    return _formatIrrigation(_irrigationType!);
  }

  // ============================================================
  // FORMAT / RESOLVE SOIL TYPE
  // ============================================================
  ...
  String _getSoilTypeName(
    List<SoilTypeModel>? list,
  ) {
    if (_soilType == null || _soilType!.isEmpty) {
      return '-';
    }
    ...
    return _formatSoilType(_soilType!);
  }
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            _FarmSetupHeader(
              title: widget.setupFlow
                  ? 'Daftarkan Lahan Sawah'
                  : 'Tambah Lahan Sawah',
              subtitle:
                  'Lengkapi 4 langkah pendaftaran sawah & pemetaan polygon',
              onBack: _cancel,
            ),
...
class _MapPolygonPicker
  ...
  @override
  State<_MapPolygonPicker> createState() =>
      _MapPolygonPickerState();
}

class _MapPolygonPickerState
    extends State<_MapPolygonPicker> {
  final _mapKey =
      GlobalKey();
          ...
          if (points.isEmpty)
            ...
            ...points.asMap().entries
              ...
              (entry) => ListTile(
                ...
                title: Text(
                  '${entry.value.lat.toStringAsFixed(7)}, '
                  '${entry.value.lng.toStringAsFixed(7)}',
                  maxLines: 1,
                  overflow:
                      TextOverflow.ellipsis,
                  style:
