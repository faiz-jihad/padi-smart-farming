...
final appRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/notif', redirect: (context, state) => '/notifications'),
      GoRoute(
        path: '/notifikasi',
        redirect: (context, state) => '/notifications',
      ),
      GoRoute(path: '/radar', redirect: (context, state) => '/community-alert'),
      GoRoute(
        path: '/alerts',
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          if (isBuyer) {
            return const _MainTabScaffold(currentIndex: 2, child: CartScreen());
          }
