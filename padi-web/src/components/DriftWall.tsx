  ...
  const renderTile = (item: DriftWallItem, id: string, colIndex: number) => {
    const inner = (
      <span className="drift-wall__inner">
        ...
        {item.title && (
          <span className="absolute bottom-2 inset-x-2 px-2.5 py-1 rounded-lg bg-black/60 backdrop-blur-md text-[10px] sm:text-[11px] font-bold text-white truncate shadow-sm flex items-center gap-1.5 pointer-events-none">
